...
export const SearchContext = createContext<SearchingContext | undefined>(
	undefined
);

export function useSearchContext(): SearchingContext {
	const c = useContext(SearchContext);
	if (!c) {
		throw "Must be wrapped in a SearchContext.Provider";
	}
	return c;
}
